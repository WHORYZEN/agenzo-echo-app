...
import workJouri from "@/assets/work-jouri.png.asset.json";
import workMyca500 from "@/assets/work-myca500.png.asset.json";
const project1 = workMyai500.url;
...
function StatTile({ label, value, right }: { label: string; value: string; right?: React.ReactNode }) {
  return (
    <div className="bg-[var(--brand-blue)] text-white rounded-3xl p-6 flex flex-col justify-between min-h-[180px] h-full">
      <div className="text-[19px] opacity-80">{label}</div>
